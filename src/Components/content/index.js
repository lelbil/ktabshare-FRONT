    ...
    render = () => (
        <div id={"content"}>
            ...
            <div id={"box3"} className={"box"}>
                <BookList logged={this.props.logged} query={this.state.query} handlePage={this.handlePage} reservations={this.props.reservations} myBooks={this.props.myBooks} edit={this.props.edit}/>
            </div>
        </div>
        )
}
